...
## How do you delete the entire file contents in Vi/Vim editor?

 At times, we may need to wipe off the contents of the file before we paste the new /revised contents. Though we can very well do it outside Vi/Vim at the OS/Shell level, few of us really get that thought only after opening the file in Vi/Vim. This FAQ is for such people, so that they don' need to get out of Vi/Vim just for emptying the file :)

 There are two ways you can accomplish this objective.
