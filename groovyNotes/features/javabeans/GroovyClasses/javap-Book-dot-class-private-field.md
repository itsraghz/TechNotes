...
As the class has a specific access specifier (`private`) specified for the field 'title',
Groovy Compiler does *NOT* produces the `getter` and `setter`.

```
Compiled from "BookTestPrivate.groovy"
public class BookPrivateField implements groovy.lang.GroovyObject {
  ...
  protected groovy.lang.MetaClass $getStaticMetaClass();
    Code:
       ...
       4: ldc           #2                  // class BookPrivateField
       6: if_acmpeq     14
       9: aload_0
